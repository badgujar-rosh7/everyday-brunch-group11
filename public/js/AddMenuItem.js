...
if(!reg.test(`${price}`)){
    alert(price)
    $('#errordiv').empty();
    $('#errordiv').append('<p>Select a Valid price for item. NO SPECIAL CHARACTERS ONLY NUMBERS OR POINT VALUES. VALUE SHOULD BE UPTO TWO DECIMALS ONLY<p>');
        $('#errordiv').show();
        return;
}
if(!reg.test(`${Calories}`)){
    alert(Calories)
    $('#errordiv').empty();
    $('#errordiv').append('<p>Select a Valid Calories for item. NO SPECIAL CHARACTERS ONLY NUMBERS OR POINT VALUES<p>');
        $('#errordiv').show();
        return;
}
