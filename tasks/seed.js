...
async function main() {
  ...
  //  Users
    ...
    //hot brew
    //hazelnut coffee
    const catF=await menuData.addCategory('Salad','s.jpg')
    ...
    const menu8=await menuData.addMenu(getallcat[2].category,'Kale Smoothies','Green King blended with ample fruits to blend its raw taste','19.99','159','beverages2.jpg','kalegreensmoothiesfruitsfiber');
    ...
    reviewA = await reviews.createReview(reviewA.userId,reviewA.review,reviewA.rating,reviewA.dateofReview);
    reviewB = await reviews.createReview(reviewB.userId,reviewB.review,reviewB.rating,reviewB.dateofReview);
    reviewC1 = await reviews.createReview(reviewC1.userId,reviewC1.review,reviewC1.rating,reviewC1.dateofReview);
    reviewC2 = await reviews.createReview(reviewC2.userId,reviewC2.review,reviewC2.rating,reviewC2.dateofReview);
